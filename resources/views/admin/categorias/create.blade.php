                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nombre" id="nombre" class="form-control" value="{{ old('nombre') }}" placeholder="Nombre de la Categoria" required>
                                    </div>
                                    @error('nombre')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug') }}" placeholder="Slug-de-la-Categoria" readonly required>
                                    </div>
                                    @error('slug')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        rows="4" placeholder="Descripcion de la Categoria (Opcional)"> {{ old('descripcion') }}</textarea>
                                    </div>
                                    @error('descripcion')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
