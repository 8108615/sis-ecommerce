                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="codigo" id="codigo" class="form-control"
                                            value="{{ old('codigo', $producto->codigo) }}" placeholder="Codigo unico del Producto" required>
                                    </div>
                                    @error('nombre')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="descripcion_corta" id="descripcion_corta" class="form-control"
                                                    ...
                                                    maxlength="255" value="{{ old('descripcion_corta', $producto->descripcion_corta) }}" required>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                class="form-control" value="{{ old( 'stock', $producto->stock) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div style="width: 100%">
                                                    ...
                                                    placeholder="Descripcion detallada del Producto">{{ old('descripcion_larga', $producto->descripcion_larga) }} </textarea>
                                                </div>       
                                            </div>
