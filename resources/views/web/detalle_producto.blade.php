...
@section('content')
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Detalle de Producto: {{ $producto->nombre }}</h1>
      </div>
    </div><!-- End Page Title -->
              ...
              <div class="thumbnail-grid">
                ...
                @foreach ($producto->imagenes as $item) 
                  ...
                  <div class="thumbnail-wrapper thumbnail-item active" 
                    ...
                    <img src="{{ asset('storage/'.$item->imagen) }}" alt="View {{ $loop->iteration }}"  alt="Product Thumbnail"
                      class="img-fluid">
                  </div>
                @endforeach
          ...
          <div class="col-12">
            <div class="info-tabs-container">
              <nav class="tabs-navigation nav">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#ecommerce-product-details-5-overview" type="button">Descripcion del Producto</button>
