                            ...
                            <form action="{{ url('/web/login') }}" method="POST" class="auth-form-content">
                                ...
                                <div class="form-options mb-4">
                                    <div class="remember-me">
                                        ...
                                        <label for="rememberLogin">Acuerdate de Mí</label>
                                    </div>
                                    <a href="#" class="forgot-password">¿Has Olvidaste tu Contraseña?</a>
                                </div>
                                ...
                                <div class="switch-form">
                                    ...
                                    <a href="{{ url('/web/registro') }}" type="button" class="switch-btn" data-target="register">Crear una Cuenta</a>
                                </div>
                            </form>
                        </div>
                    </div>
